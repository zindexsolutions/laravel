...
@section('head-javascript')
    <script>
            $(document).ready(function(){
                ...
                $.ajax({
                    url: ProjectUrl +"/api/show-user/{{ $id }}",
                    type: "get",

                    success:function(response){

                        $('#saveUser input[name=id]' ).val(response.id);
                        $('#saveUser input[name=name]' ).val(response.name);
                        $('#saveUser input[name=email]' ).val(response.email);
                    },
                ...
                $('.save-user').click(function(event){
                    ...
                    $.ajax({
                        url: ProjectUrl +"/api/update-user",
                        type: "post",
